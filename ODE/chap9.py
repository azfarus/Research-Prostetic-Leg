...
solution = adams_bashforth4_solver(system_dynamics, t_span, x0, args=(control_input,), t_eval=t_eval)
...
ax[0].plot(solution['t'], solution['y'][0,:], label="position")
ax[0].plot(solution['t'], 0.1*np.sin(solution['t']), label="trajectory")
ax[0].plot(solution['t'], 0.1*np.sin(solution['t']) - solution['y'][0,:] , label="error")

ax[1].plot(solution['t'], solution['y'][1,:], label="velocity")
ax[1].plot(solution['t'], 0.1*np.cos(solution['t']), label="trajectory")
ax[1].plot(solution['t'], 0.1*np.cos(solution['t']) - solution['y'][1,:] , label="error")
